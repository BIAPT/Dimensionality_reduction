...
MODES = ["wpli"]  # can be "dpli", "wpli", "both"
    ...
    for MODE in MODES:
        for STEP in STEPS:
            ...
            for p_id in IDS:
                ...
                channels_on_path = INPUT_DIR + "{}PLI_{}_step{}_{}_{}_channels.mat".format(MODE[0], frequency, STEP,
                                                                                           p_id, ON)
                data_off_path = INPUT_DIR + "{}PLI_{}_step{}_{}_{}.mat".format(MODE[0], frequency, STEP, p_id, OFF)
                channels_off_path = INPUT_DIR + "{}PLI_{}_step{}_{}_{}_channels.mat".format(MODE[0], frequency, STEP,
                                                                                            p_id, OFF)
