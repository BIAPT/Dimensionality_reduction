...
pdf = matplotlib.backends.backend_pdf.PdfPages("individual_PCA_BA_path_{}.pdf".format(mode))
...
for part in participants:
    ...
    X_part_2 = pca.fit_transform(X_part)
    ...
    X_part_3 = pca.fit_transform(X_part)
